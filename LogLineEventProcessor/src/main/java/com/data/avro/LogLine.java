...
public class LogLine extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"LogLine\",\"namespace\":\"com.data.avro\",\"fields\":[{\"name\":\"ip\",\"type\":\"string\"},{\"name\":\"timestamp\",\"type\":\"long\"},{\"name\":\"url\",\"type\":\"string\"},{\"name\":\"referrer\",\"type\":\"string\"},{\"name\":\"useragent\",\"type\":\"string\"},{\"name\":\"sessionid\",\"type\":[\"null\",\"int\"],\"default\":null}]}");
  ...
  public static com.data.avro.LogLine.Builder newBuilder() {
    return new com.data.avro.LogLine.Builder();
  }
  
  /** Creates a new LogLine RecordBuilder by copying an existing Builder */
  public static com.data.avro.LogLine.Builder newBuilder(com.data.avro.LogLine.Builder other) {
    return new com.data.avro.LogLine.Builder(other);
  }
  
  /** Creates a new LogLine RecordBuilder by copying an existing LogLine instance */
  public static com.data.avro.LogLine.Builder newBuilder(com.data.avro.LogLine other) {
    return new com.data.avro.LogLine.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LogLine>
    ...
    private Builder() {
      super(com.data.avro.LogLine.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.data.avro.LogLine.Builder other) {
      super(other);
    ...
    private Builder(com.data.avro.LogLine other) {
            super(com.data.avro.LogLine.SCHEMA$);
      if (isValidValue(fields()[0], other.ip)) {
        this.ip = data().deepCopy(fields()[0].schema(), other.ip);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'ip' field */
    public com.data.avro.LogLine.Builder setIp(java.lang.CharSequence value) {
    ...
    public com.data.avro.LogLine.Builder clearIp() {
      ip = null;
    ...
    /** Sets the value of the 'timestamp' field */
    public com.data.avro.LogLine.Builder setTimestamp(long value) {
    ...
    public com.data.avro.LogLine.Builder clearTimestamp() {
    ...
    /** Sets the value of the 'url' field */
    public com.data.avro.LogLine.Builder setUrl(java.lang.CharSequence value) {
    ...
    public com.data.avro.LogLine.Builder clearUrl() {
      url = null;
    ...
    /** Sets the value of the 'referrer' field */
    public com.data.avro.LogLine.Builder setReferrer(java.lang.CharSequence value) {
    ...
    public com.data.avro.LogLine.Builder clearReferrer() {
      referrer = null;
    ...
    /** Sets the value of the 'useragent' field */
    public com.data.avro.LogLine.Builder setUseragent(java.lang.CharSequence value) {
    ...
    public com.data.avro.LogLine.Builder clearUseragent() {
      useragent = null;
    ...
    /** Sets the value of the 'sessionid' field */
    public com.data.avro.LogLine.Builder setSessionid(java.lang.Integer value) {
    ...
    public com.data.avro.LogLine.Builder clearSessionid() {
      sessionid = null;
